    ...
    return ( 
        <div>
            ...
            <ul className="orders__list">
                ...
                <li className="orders__tab">
                    <div className="orders__tab-left">
                        <div className="orders__tab-status--image">
                    ...
                    <div className="orders__tab-middle">
                        <div className="orders__tab-price--title">

                        </div>
                        <div className="orders__tab-price">

                        </div>
                    </div>
                    <div className="orders__tab-right">
                        <img src="" alt="product image" className="orders__tab-image" />
                    </div>
                </li>
                </div>
                <div className="orders__top">
