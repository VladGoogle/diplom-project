        ...
        <div className="container">
          <div className="header__bottom-items">
            ...
            >
              ...
              <span className='catalog__button-text'>PRODUCT CATALOG</span>
              <span className='catalog__button-text_mini'>CATALOG</span>
              <svg
                alt="arrow"
                width="36"
                height="36"
                ...
                {loggedIn ? (
                  <li className="header__bottom-item">
                    <NavLink
                      ...
                      className="header__bottom-icon header__bottom-icon-wishlist"
                    >
                      <svg
                        alt="Likes"
                        width="36"
                  ...
                  <li className="header__bottom-item header__bottom-icon-wishlist">
<svg      
