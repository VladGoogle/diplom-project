        ...
        <div className="sidebar_bg">
            <div className="sidebar">
                <div className="sidebar_close">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" onClick={props.onCloseSidebar}>
                ...
                <ul className="sidebar-items">
                    {showSettingsButton ? (
                        <li className="sidebar-item">
                            <NavLink to="/settings/account" className="sidebar-link">ACCOUNT</NavLink>
                        </li>
                    ) : (
                        <li className="sidebar-item">
                            <a href="#" className="sidebar-link" onClick={props.onClickSignup}>
                                ACCOUNT
                            </a>
                        </li>
                    )}
                    {loggedIn ? (
                        <li className="sidebar-item">
                            <NavLink to="/settings/wishlist" className="sidebar-link">
                                WISHLIST
                            </NavLink>
                        </li>
                    ) : (
                        <li className="sidebar-item">
                            <a href="#" className="sidebar-link sidebar-wishlist__unactive">
                                WISHLIST
                            </a>
                        </li>
                    )}
                    ...
                    <li className="sidebar-item sidebar__bottom-languages">
                        <a className="sidebar__button-language ukr-language">UKR</a>
                        <svg
                            alt="line"
                        ...
                        <a className="sidebar__button-language eng-language">ENG</a>
                    </li>
                </ul>
            </div>
        </div>
