                        ...
                        <ul className="breadcrumbs__list">
                            <li className="breadcrumbs__item breadcrumbs__item-home">
                                <a href="#" className="breadcrumbs__link">
                                    <svg alt="home" className="home__icon" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <svg alt="arrow" className="breadcrumbs__icon" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="goods__left">
                            <div className="goods__main">
                                ...
                                <p className="goods__description">
                                    Lorem ipsum dolor sit amet consectetur. Morbi vehicula porttitor porta lobortis id dolor.
                                    Tellus
                                    varius vel
                                    at vulputate elementum ut sit. Penatibus lectus lacus enim convallis vitae ipsum neque. Eu
                                    ornare tincidunt
                                    neque nec cursus leo viverra. Egestas purus amet erat id sed consectetur. Potenti quam eget
                                    metus purus vel.
                                    Egestas elementum lectus risus ac ac vivamus. Sit nulla dolor velit tortor eu justo
                                    praesent. A
                                    sed
                                    tincidunt vitae enim ut integer. Urna pulvinar aliquam sit mi maecenas. Arcu mauris
                                    habitasse
                                    lectus
                                    volutpat turpis lacus sed. Arcu aliquam fringilla orci ac eget nam elementum ultricies nunc.
                                    Vitae mauris
                                    dictum turpis congue fringilla vitae cursus diam ullamcorper. Ornare erat nisl donec eget
                                    augue
                                    scelerisque
                                    etiam.
                                </p>
                        ...
                        <div className="goods__right">
                            ...
                            <div className="goods__price-top">
                                <div className="goods__price-old">
                                    ...
                                    <span className="goods__price-old--text">
                                        499.99$
                                    </span>
                                </div>
                                <div className="goods__delivery-cost">
                                    <span className="goods__delivery-cost--text">The cost of delivery goods to <b
                                        className="goods__delivery-cost--city">Odesa - 10$</b></span>
                                </div>
                            </div>
                            <div className="goods__price-bottom">
                                <div className="goods__new-price">
                                    ...
                                    <span className="goods__price-new--text">
                                        299.99$
                                    </span>
                                </div>
                                <svg alt="line" className="vertical-line" width="2" height="60" viewBox="0 0 2 46" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="goods__buttons">
                                <div className="goods__quantity">
                                    <Counter/>
                                    <span className="goods__in-stock">
                                        In stock: 10
                                    </span>
                                </div>
                                <button className="goods__buttons-add">
                                    ADD TO CART
                                </button>
                                <button className="goods__buttons-buy">
                                    BUY IN ONE CLICK
                                </button>
                            </div>
                            <div className="goods__details">
                                <div className="goods__details-container">
                                    <div className="goods__details-top" id="details1">
                                        <h3 className="goods__details-title">
                                            PRODUCT DETAILS
                                        </h3>
                                        <svg alt="arrow" width="36" height="36" viewBox="0 0 36 36" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="goods__details-content">
                                        <p className="goods__details-text">
                                            Lorem ipsum dolor sit amet consectetur. Morbi vehicula porttitor porta lobortis id
                                            dolor.
                                            Tellus varius vel at vulputate elementum ut sit. Penatibus lectus lacus enim
                                            convallis
                                            vitae
                                            ipsum neque. Eu ornare tincidunt neque nec cursus leo viverra. Egestas purus amet
                                            erat
                                            id
                                            sed consectetur. Potenti quam eget metus purus vel
                                        </p>
                                    </div>
                                </div>
                                <div className="goods__details-container">
                            ...
                            <div className="care__instructions">
                                <div className="care__instrucions-top">
                                    <svg alt="exclamation_mark" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="care__instructions-bottom">
                                    <div className="care_instructions-text">
                                        Lorem ipsum dolor sit amet consectetur. Dui penatibus fermentum donec augue adipiscing
                                        nec
                                        et felis commodo. Vel nulla nascetur ac neque consequat cursus orci in nunc. Faucibus
                                        euismod porttitor luctus elementum viverra dui faucibus aliquam faucibus. Vel fringilla
                                        aliquam ut vel libero varius viverra mattis.
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="tab-container">
                        <div className="tab-buttons">
                            <div className="tab-button active" data-tab="most-often-choose">MOST OFTEN CHOOSE</div>
                            <div className="tab-button" data-tab="included-with">INCLUDED WITH</div>
                            <div className="tab-button" data-tab="you-watched">YOU WATCHED</div>
                        </div>
                                ...
                                <ul className="products-card-list">
                                    <li className="products__card" data-tab="most-often-choose">
                                        <div className="products__card-top">
                                            <span className="products-card__status">
                                                DISCOUNT
                                            </span>
                                            <svg className="products__card-like" width="36" height="36" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                        ...
                                        <div className="product__card-content">
                                            <div className="card__image-container">
                                                <a href="product.html" className="card__image-link"><img src={card_image} alt="card_image"
                                                    className="products__card-image" /></a>
                                            </div>
                                    ...
                                    <li className="products__card" data-tab="most-often-choose">
                                        ...
                                        <div className="product__card-content">
                                            <div className="card__image-container">
                                                <a href="#" className="card__image-link"><img src={card_image} alt="card_image"
                                                    className="products__card-image" /></a>
                                            </div>
                                            <div className="products__card-bottom">
                                                <span className="products__category-title">
